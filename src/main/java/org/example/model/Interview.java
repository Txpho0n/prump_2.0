...
public class Interview {
    ...
    //Constructor
    public Interview(Long id, Long topicId, String partner1Id, String partner2Id, String assignedTaskForUser1, String assignedTaskForUser2, String roomLink, LocalDateTime start_time, LocalDateTime end_time) {
        this.id = id;
    ...
    public String getRoomLink() {return roomLink;}
   ...
   //Setters
    ...
    public void setRoomLink(String roomLink) {this.roomLink = roomLink;}
